...
<body>
													...
													<div class="product-display">
														<div class="product-info">
															...
															<div id="item-color-opt" class="product-colorways-number">
																<span id="${AllListWomen.code}1kn" class="text-color-secondary">
	...
	<div class="paging">
		<c:if test="${paging.startPage != 1 }">
			<a href="/nike/Women?nowPage=${paging.startPage - 1 }">이전</a>
		</c:if>
		<c:forEach begin="${paging.startPage }" end="${paging.endPage }" var="p">
			<c:choose>
				...
				<c:when test="${p != paging.nowPage }">
					<a href="/nike/Women?nowPage=${p }">${p }</a>
				</c:when>
			</c:choose>
		</c:forEach>
		<c:if test="${paging.endPage != paging.lastPage}">
			<a href="/nike/Women?nowPage=${paging.endPage+1 }">다음</a>
		</c:if>
	</div>
	</div>
				</div>
