...
<body>
	<div style="width: 60%; margin: auto; padding-top: 80px;">
		...
		<div>
			<!-- 우측 주문금액 내역  -->
			<aside class=""
				style="float: right; width: 300px; height: 800px; margin-top: -30px;">
				<section style="padding: 20px;">
					...
					<div>
						...
						<div style="text-align: right;">원</div>
						<br> ㆍ장기간 장바구니에 보관하신 상품은 시간이 지남에 따라 가격과 혜택이 변동 될 수 있으며, 최대
						30일동안 보관됩니다.
					</div>
				</section>
			</aside>
				...
				<section
					...
					<div>
						<div style="float: left; width: 50%;">
							받으시는분<br> <input type="text" placeholder="이름">
						</div>
						<div style="float: left; width: 50%;">
							연락처<br> <input type="text" placeholder="-없이 입력">
						</div>
					</div>
					<!-- 배송주소-->
					<div>
					...
					</select> <input type="text" placeholder="배송메모를 직접 입력하여 주십시오."><br>
					※ 배송 수령 시간은 임의로 지정하실 수 없습니다.<br> ※ 배송 메세지에 특수문자 "\ 사용이 불가합니다.<br>
					<br>
					<hr style="width: 100%;">
					<div>
						<h3>배송방식 선택</h3>
						<br> <input type="radio" name="delivery">일반배송 : 배송비
						무료<br>
						<p>
							ㆍ 배송지역 : 전국(일부 도서산간 지역 제외)<br> ㆍ 배송기간 : 결제 후 3일 이내(토, 공휴일
							제외)<br>
							<br>
							<br> <input type="radio" name="delivery">오늘도착 : 서비스
							비용 5,000원 [나이키멤버 전용]<br>
						<p>
							ㆍ 배송지역 : 서울ㆍ분당<br> ㆍ 이용시간 : 13시까지 결제 시, 당일 도착(공휴일 제외)<br>
							ㆍ 구매수량 : 1회 주문시, 최대 수량 2개<br> ㆍ 도착시간 : 저녁 6시 ~ 밤 10시 사이에 도착
							예정, 배송업체 상황에 따라 조금 지연될 수 있습니다.<br> 오늘 밤에 받으실 배송지 주소를 한번더 확인해
							주세요.
					</div>
					<br>
					<hr style="width: 100%;">
